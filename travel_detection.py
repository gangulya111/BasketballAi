...
file = "/Users/arkoganguly/BasketballAi/IMG_2815.MOV"
...
while cap.isOpened():
    ...
    cv2.putText(combined_frame, f"Avg Ball Height: {avg_ball_height:.1f} px", (40, 100),
    ...
    # Save and display
    full_output.write(combined_frame)
...
print(f"Full motion video saved at: {full_output_path}")
